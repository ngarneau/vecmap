...
do
    ...
    do
        ...
        python3 map_embeddings.py --acl2018 ./data/embeddings/${source_language}.emb.txt ./data/embeddings/${target_language}.emb.txt ./output/${source_language}.${target_language}.${counter}.emb.txt ./output/${target_language}.${source_language}.${counter}.emb.txt
